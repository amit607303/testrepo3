    ...
    <header>
      <div class="brand">
        <img
          ...
          alt="logo"
        />
        <a href="https://t.me/kevinXP">
          <h2 class="name">Qbittorrent Selection</h2>
        </a>
      </div>
      <div class="social">
        <a href="https://github.com/weebzone/WZML"><i class="fab fa-github"></i></a>
        <a href="https://t.me/SachinMirror"><i class="fab fa-telegram"></i></a>
      </div>
    </header>
    <div id="sticks">
...
@app.route('/')
def homepage():
    return "<html><title>Kevins WebServer</title><link rel='stylesheet' href='https://www.w3schools.com/w3css/4/w3.css'><center><body class='w3-container w3-auto w3-mobile'><div class='w3-panel w3-round-large w3-border w3-green w3-left-align' style='width:90%'><h3>Success <span style='line-height:0.6em;''>&#10004;</span></h3><p>Server Online!!</p></div></body></center></html>"
