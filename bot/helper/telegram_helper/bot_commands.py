...
class _BotCommands:
    def __init__(self):
        ...
        self.BotSetCommand = getCommand(f'BOT_SETTING', f'bst{CMD_SUFFIX}')
        self.CancelMirror = getCommand(f'CANCEL_COMMAND', f'cancel{CMD_SUFFIX}')
        self.CancelAllCommand = getCommand(f'CANCEL_ALL_COMMAND', f'cancelall{CMD_SUFFIX}'), f'call'
        ...
        self.PingCommand = getCommand(f'PING_COMMAND', f'ping{CMD_SUFFIX}'), f'p{CMD_SUFFIX}', f'p'
        self.RestartCommand =  getCommand(f'RESTART_COMMAND', f'restart{CMD_SUFFIX}'), f'r{CMD_SUFFIX}', f'r'
        ...
        self.LogCommand = getCommand(f'LOG_COMMAND', f'lol{CMD_SUFFIX}')
        self.BtSelectCommand = getCommand(f'BTSEL_COMMAND', f'btsel{CMD_SUFFIX}')
        self.SpeedCommand = getCommand(f'SPEEDTEST_COMMAND', f'st{CMD_SUFFIX}')
        ...
        self.ShellCommand = getCommand(f'SHELL_COMMAND', f'she{CMD_SUFFIX}')
        ...
        self.EvalCommand = f'eva{CMD_SUFFIX}'
        self.ExecCommand = f'exe{CMD_SUFFIX}'
